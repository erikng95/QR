...
static	uchar	densidad_ean;
  #if QR_CODE
uchar	buf_auxiliar_parser[1024],buf_qr[1024],num_digitos_codigo_barras,IA_ap_cp;
  #else
...
uint 	obtenNumDig (void)
{
	return (num_digitos_codigo_barras - (1+IA_ap_cp)); /* el -1 a la longitud es por el caracter FNC1 que hay al comienzo */
}
